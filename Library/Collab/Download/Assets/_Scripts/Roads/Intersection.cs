...
public class Intersection : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (null != occupants[0,0] && LightDirection.West == occupants[0,0].path.Peek() && TestRoad(outWestRoad) && Time.frameCount != occupants[0,0].frameMoved)
        {
        ...
        if (null != occupants[0, 0] && (LightDirection.East == occupants[0, 0].path.Peek() || LightDirection.South == occupants[0, 0].path.Peek()) && null == occupants[1, 0] && Time.frameCount != occupants[0, 0].frameMoved)
        {
        ...
        if (null != occupants[0, 0] && LightDirection.North == occupants[0, 0].path.Peek() && null == occupants[0, 1] && Time.frameCount != occupants[0, 0].frameMoved)
        {
        ...
        if (null != occupants[0, 1] && LightDirection.North == occupants[0, 1].path.Peek() && TestRoad(outNorthRoad) && Time.frameCount != occupants[0, 1].frameMoved)
        {
            occupants[0, 1].frameMoved = Time.frameCount;
        ...
        if (null != occupants[0, 1] && (LightDirection.West == occupants[0, 1].path.Peek() || LightDirection.South == occupants[0, 1].path.Peek()) && null == occupants[0, 0] && Time.frameCount != occupants[0, 1].frameMoved)
        {
        ...
        if (null != occupants[0, 1] && LightDirection.East == occupants[0, 1].path.Peek() && null == occupants[1, 1] && Time.frameCount != occupants[0, 1].frameMoved)
        {
        ...
        if (null != occupants[1, 0] && LightDirection.South == occupants[1, 0].path.Peek() && TestRoad(outSouthRoad) && Time.frameCount != occupants[1, 0].frameMoved)
        {
            occupants[1, 0].frameMoved = Time.frameCount;
        ...
        if (null != occupants[1, 0] && (LightDirection.East == occupants[1, 0].path.Peek() || LightDirection.North == occupants[1, 0].path.Peek()) && null == occupants[1, 1] && Time.frameCount != occupants[1, 0].frameMoved)
        {
        ...
        if (null != occupants[1, 0] && LightDirection.West == occupants[1, 0].path.Peek() && null == occupants[0, 0] && Time.frameCount != occupants[1, 0].frameMoved)
        {
        ...
        if (null != occupants[1, 1] && LightDirection.East == occupants[1, 1].path.Peek() && TestRoad(outEastRoad) && Time.frameCount != occupants[1, 1].frameMoved)
        {
            occupants[1, 1].frameMoved = Time.frameCount;
        ...
        if (null != occupants[1, 1] && (LightDirection.West == occupants[1, 1].path.Peek() || LightDirection.North == occupants[1, 1].path.Peek()) && null == occupants[0, 1] && Time.frameCount != occupants[1, 1].frameMoved)
        {
        ...
        if (null != occupants[1, 1] && LightDirection.South == occupants[1, 1].path.Peek() && null == occupants[1, 0] && Time.frameCount != occupants[1, 1].frameMoved)
        {
        ...
        if(null == occupants[1,1] && ((LightDirection.North == lightController.LightDirection && LightColor.Green == lightController.LightColor) || lightController.GetType() == typeof(Turn)))
        {
        ...
        if (null == occupants[1, 0] && ((LightDirection.East == lightController.LightDirection && LightColor.Green == lightController.LightColor) || lightController.GetType() == typeof(Turn)))
        {
        ...
        if (null == occupants[0,1] && ((LightDirection.West == lightController.LightDirection && LightColor.Green == lightController.LightColor) || lightController.GetType() == typeof(Turn)))
        {
        ...
        if (null == occupants[0, 0] && ((LightDirection.South == lightController.LightDirection && LightColor.Green == lightController.LightColor) || lightController.GetType() == typeof(Turn)))
        {
