...
public class Intersection : MonoBehaviour
{
    ...
    private IntersectionStatistics intersectionStatistics;
    ...
    void Update()
    {
        ...
        {
            intersectionStatistics.throughput++;//moving car into intersection so increment throughput
            Console.WriteLine("throughput: " + intersectionStatistics.throughput);
            occupants[1, 1].distanceTraveled++;//STATS
